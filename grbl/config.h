...
#define DEFAULTS_SHAPEOKO_sebbra
...
//#define PIN_MAP_CUSTOM_SEBBRA
#define CPU_MAP_CUSTOM_1284p
...
#define LINE_BUFFER_SIZE 100  // Uncomment to override default in protocol.h
